# VENDORED, UNMODIFIED, from https://github.com/andmek/AT4MT (MIT licence).
# Amharic Transliteration for Machine Translation, Gezmu et al. 2021b — the exact
# scheme used by Gezmu, Nurnberger & Bati (LREC 2022) whose NMT-8K result this
# repo reproduces. Vendored rather than fetched so builds are offline and pinned.
# Retrieved 2026-08-11. Do not edit; see experiments/domain_breadth/arms.py for usage.
"""
