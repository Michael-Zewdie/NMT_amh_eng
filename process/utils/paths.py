...
# CCALIGNED_FULL removed 2026-08-14 with collect/ccaligned.py — its only consumer.
# Both, plus the extracted release, are under archive/ if it is ever restored.
...
FIGS      = DATA / "figs"       # generated charts (outside processed/ — they describe every stage, not just that one)
